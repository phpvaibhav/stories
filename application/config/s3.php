...
$config['access_key'] = 'AKIAWHQCAUC4MBUMF7O2';

// Test purpose
//$config['access_key'] = 'AKIASAIHZCRBQ5IEKO6X';
...
$config['secret_key'] = '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';

// Tser purpose
//$config['secret_key'] = '/QGWZ+Zev3taz5H8po5a3Xq/h8ZwCycaY3cBQ5WN';
