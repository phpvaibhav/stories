            ...
            <div class="col-lg-9 col-md-12 col-sm-12 col-xs-12">
                <div class="page-wrapper">
                    ...
                    <div class="blog-content">  
                        ...
                        <img src="<?php echo $frontend_assets;?>upload/tech_menu_09.jpg" alt="" class="img-fluid img-fullwidth">
                    ...
                    <div class="custombox authorbox clearfix">
                        ...
                        <div class="row">
                            <div class="col-lg-2 col-md-2 col-sm-2 col-xs-12">
                                <img src="<?php echo $frontend_assets;?>upload/author.jpg" alt="" class="img-fluid rounded-circle"> 
                            </div><!-- end col -->
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="comments-list">
                                    ...
                                    <div class="media">
                                        <a class="media-left" href="#">
                                            <img src="<?php echo $frontend_assets;?>upload/author_01.jpg" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
                                    ...
                                    <div class="media last-child">
                                        <a class="media-left" href="#">
                                            <img src="<?php echo $frontend_assets;?>upload/author_02.jpg" alt="" class="rounded-circle">
                                        </a>
                                        <div class="media-body">
